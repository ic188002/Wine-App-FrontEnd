...
export default function WineIndex(props) {
 ...
 <Link  key={index} to={`/${category.url}`} style={{textDecoration: "none"}}> 
 <WineCard  loadWineIndex={() => props.loadWineIndex(category)} key={index} {...category}></WineCard></Link>
    ))
    ...
    <div>
      <div className='filter'>
        ...
        <div className='filterby'>
          ...
          <img   onClick={handleSecondClick}   className='white' src='images/all.png' height='100px' alt="" />
