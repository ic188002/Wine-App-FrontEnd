...
export default function SauvignonWineList() {
    ...
    const loadWineList = () => {
        Axios.get('https://api.spoonacular.com/food/wine/recommendation?wine=sauvignon_blanc&number=1&apiKey=7a64dea7d5bb41f38bb3b24933947711') 
